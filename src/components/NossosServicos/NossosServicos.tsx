...
const NossosServicos = () => {
    return (
        <section className={styles.containerMainServicos}>
            ...
            <section className={styles.containerCardsServicos}>
                <div className={styles.cardInfo}>
                    ...
                    <p>A Hapse oferece consultoria personalizada para produtores rurais, agroindústrias e serviços de alimentação, com foco em:</p>
                ...
                <div className={styles.cardParceiros}>
                    ...
                    <div className={styles.cardParceiroSebrae}>
                        ...
                        <p>Somos parceiros do SEBRAE, oferecendo soluções para a cadeia agroalimentar com benefícios que reduzem custos e aumentam a competitividade. </p>

                        <a className={styles.btnSaibaMaisSebrae} href="">Saiba mais sobre os benefícios </a>
