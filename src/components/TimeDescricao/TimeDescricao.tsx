        ...
        {cardTime.map((member, index) => (
          <div className={styles.cardMember} key={index}>
            ...
            <div className={styles.imageContainer}>
              <img src={member.perfil} alt={member.nome} />
            </div>
